...
<html lang="en">
    ...
    <body>
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading"> All Cases</div>
                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['litigant_id'];?></td>
                            ...
                            <td>
                  <a href="view_cases.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> Remove</a> || <a href="#samstrover<?php echo $row['litigant_id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-pencil"></span> View</a> 
                              </td>
                          </tr>
                          <?php
