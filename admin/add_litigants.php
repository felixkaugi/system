...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" class="sammacmedia">
                <div class="sidebar-header">
                    <h3>didgital Judicial System</h3>
                    <strong>didgital Judicial System</strong>
                </div>
            ...
            <div id="content">
                ...
                <div class="line"></div>
                            ...
                            $joined = date(" d M Y ");
                            $litigant_id = rand(9999999,1000000);    
                            $tmp = rand(1,9999);
                            $phone = '254'.$phon;   
                            $file = $_FILES['file'];
                            $fileName =$file['name'];
                            ...
                            $sql_n = "SELECT * FROM litigants WHERE phone ='$phone'";
                            $res_n = mysqli_query($mysqli, $sql_n);    
                            $sql_e = "SELECT * FROM litigants WHERE email ='$email'";
                ...
                $sql = "INSERT INTO litigants (name,surname,email,joined,gender,phone,tmp,litigant_id)VALUES('$name','$surname','$email','$joined','$gender','$phone','$tmp','$litigant_id')";
                ...
                //header('Location:acc.php');
                        ...
                        <a href="#" class="close" data-dismiss="alert">&times;</a>
                        <strong> Successfully! </strong><?php echo'Thank you for adding new Litigant';?></div>
                        <?php
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading"> Add New Litigant</div>
        <div class="panel-body">
            <form method="post" action="add_litigants.php" enctype="multipart/form-data">
        <div class="row form-group">
          ...
          <div class="col-lg-6">
            <label>Email</label>
             ...
             <div class="col-lg-6">
            <label>Phone</label>
              <input type="text" class="form-control" name="phone" placeholder="+254 700 000 000" required>
            </div>  
        </div>   
         <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Gender</label>
             <select class="form-control" name="gender">
              ...
              <option>Male</option>      
                ...
                <footer>
            <p class="text-center">
            didgital Judicial System &copy;<?php echo date('F D jS Y');?>Copyright. All Rights Reserved, Powered By Kaugi    
            </p>
            </footer>
            </div>
