    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
               ...
               <!-- <div clas="col-md-12">
                    <img src="assets/image/logo" class="img-thumbnail">
                    </div>-->
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading"> All Litigants</div>
        <div class="panel-body">
                ...
                <tr>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"SELECT * FROM `litigants` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="#samstrover<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-pencil"></span> View</a> || <a href="all_litigants.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> Remove</a>
                              </td>
                          </tr>
                          <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $mysqli->prepare("DELETE FROM litigants WHERE id = ? LIMIT 1"))
                          {
