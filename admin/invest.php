...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="line"></div>
                            ...
                            $litigant_id = mysqli_real_escape_string($mysqli,$_POST['litigant_id']);
                            ...
                            $sql = "INSERT INTO cases(litigant_id,severity,case_num,notes)VALUES('$litigant_id','$severity','$case_num','$notes')";
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            <label>Select Litigant Number</label>
             <?php
                       
                    $query1 = "SELECT * FROM `litigants`";
                    $result1 = mysqli_query($mysqli, $query1);
                    ?>
                    <select class="form-control" name="litigant_id">
                    <?php while($row1 = mysqli_fetch_array($result1)):;?>
                        <option><?php echo $row1['litigant_id'];?></option>
                        <?php endwhile;?>
