...
<html lang="en">
    ...
    <body>
        ...
        <div class="panel-body">
                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                  <a href="view_users.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> Remove</a>
                              </td>
                          </tr>
                          <?php
                ...
                <footer>
            <p class="text-center">
            digital judicial &copy;<?php echo date('F D jS Y');?>Copyright. All Rights Reserved, Powered By kaugi    
            </p>
            </footer>
            </div>
